...
*** Search lab usage analytics
    This API returns lab search analytics results hosted on (vlabs, openedx or
...
*** Search institute usage analytics
    This API returns institutes search analytics results hosted on (vlabs,
...
**** API Design
  ...
  :CUSTOM_ID: openedx-usage
  :END:          
  This API returns disciplines search analytics results hosted on (vlabs,
  openedx or nonopenedx) platforms
