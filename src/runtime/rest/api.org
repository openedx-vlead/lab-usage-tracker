...
def get_openedx_usage(entity):
    if request.method == 'GET':
        ...
        if entity == "openedx":
            ...
            ANALYTICS_DB_API = "%s/%s/%s/_count?q=date_of_experiment:%s" % \
            ...
            ANALYTICS_DB_API_FOR_EDX_USAGE = "%s/usage/openedx?date=%s" % (APP_URL, current_date)
            ANALYTICS_DB_API_FOR_NONEDX_USAGE = "%s/usage/nonopenedx?date=%s" % \
