...
* REST API 
  ...
  This section contains API design documentation followed by its implementation
  and test cases
  
** Get total usage analytics of labs

   1. As of date =2017-09-21= total labs hosted on openedx platform are =90=
...
*** Get total vlabs(openedx+nonopenedx) usage
    This API returns total usage analytics of labs hosted on openedx (i.e 90)
    and non openedx platforms
  :PROPERTIES:
