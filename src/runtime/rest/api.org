...
def get_openedx_usage(entity):
    ...
    if request.method == 'GET':
        ...
        if entity not in ALLOWED_PLATFORMS:
        ...
        if platform == "openedx" or platform == "nonopenedx":
            ...
            if entity == "labs":
                ...
                if platform == "openedx":
                    ...
                    script = "[doc.lab_id.value, doc.lab_name.value, " +\
                      "doc.discipline_name.value, doc.institute_name.value, "+\
                      "doc.hits.value, doc.visits.value, "+\
                      "doc.usage.value].join('::')"
                ...
                if platform == "openedx":
                    ...
                    script = "[doc.institute_id.value, "+\
                      "doc.institute_name.value, doc.hits.value, "+\
                      "doc.vistis.value, doc.usage.value].join('::')"
                ...
                if platform == "openedx":
                    ...
                    script = "[doc.discipline_id.value, "+\
                      "doc.discipline_name.value, "+\
                      "doc.institute_name.value, doc.hits.value, "+\
                      "doc.visits.value, doc.usage.value].join('::')"
                        ...
                        for lab in search_result:
                            ...
                            try:
                                if platform == "openedx":
                                    ...
                                    usage_dict['analytics']['usage'] = lab[6]
                                usage_dict['analytics']['hits'] = lab[4]
                                usage_dict['analytics']['visits'] = lab[5]
                        ...
                        for institute in search_result:
                            ...
                            try:
                                if platform == "openedx":
                                    ...
                                    usage_dict['analytics']['usage'] = lab[4]
                                usage_dict['analytics']['hits'] = lab[2]
                                usage_dict['analytics']['visits'] = lab[3]
                        ...
                        for discipline in search_result:
                            ...
                            try:
                                if platform == "openedx":
                                    ...
                                    usage_dict['analytics']['usage'] = lab[5]
                                usage_dict['analytics']['hits'] = lab[3]
                                usage_dict['analytics']['visits'] = lab[4]
