...
*** Get total usage analytics of labs hosted on non-openedx platform
  ...
  This API returns the analytics of labs hosted on =nonopenedx= platform
**** API design  
...
*** Get total usage analytics of labs hosted on openedx platform
  ...
  :END:          
   ...
   1. This API returns analytics of all the labs hosted on openedx platform
...
*** Get usage analytics of labs
    This API returns analytics of labs hosted on =openedx= and =nonopenedx=
    platforms
**** API Design
  :PROPERTIES:
...
**** API Design
  ...
  :CUSTOM_ID: openedx_usage
  :END:          
  This API returns analytics of all the labs belongs to respective institutes
  which are hosted on =openedx= and =nonopenedx= platforms
...
*** Get usage analytics of disciplines labs
    This API return analytics of all the labs belongs to respective disciplines
    which are hosted on =openedx= and =nonopenedx= platforms
                        ...
                        for institute in search_result:
                            ...
                            try:
                                if platform == "openedx":
                                    ...
                                    usage_dict['analytics']['usage'] = institute[4]
                                usage_dict['analytics']['hits'] = institute[2]
                                usage_dict['analytics']['visits'] = institute[3]
                        ...
                        for discipline in search_result:
                            ...
                            try:
                                if platform == "openedx":
                                    ...
                                    usage_dict['analytics']['usage'] = discipline[5]
                                usage_dict['analytics']['hits'] = discipline[3]
                                usage_dict['analytics']['visits'] = discipline[4]
