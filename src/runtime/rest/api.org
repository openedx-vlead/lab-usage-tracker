...
**** API design  
    ...
    - URL :: /usage/nonopenedx?till_date=<<YYYY-MM-DD>
...
**** API design  
    ...
    - URL :: /usage/openedx?till_date=<<YYYY-MM-DD>
...
**** API design  
    ...
    - URL :: /usage/vlabs?till_date=<<YYYY-MM-DD>
...
** Get usage analytics openedx platform
   ...
   - Query to get the lab-wise usage of openedx platform
    ...
    #+END_EXAMPLE
*** Get usage analytics of labs hosted on openedx platform
**** API Design
  :PROPERTIES:
  :CUSTOM_ID: openedx_usage
  :END:          

    - URL :: /labs/openedx?top=n&till_date=<YYYY-MM-DD>
...
*** Get usage analytics of institute's labs
**** API Design
  :PROPERTIES:
  :CUSTOM_ID: openedx_usage
  :END:          

    - URL :: /institutes/openedx?top=n&till_date=<YYYY-MM-DD>
    ...
    - Notes ::
      ...
      + If query parameter =top= is not passed by default API returns all the
        labs in =descending= order
*** Get usage analytics of discipline's labs
**** API Design
  :PROPERTIES:
  :CUSTOM_ID: openedx_usage
  :END:          

    - URL :: /disciplines/openedx?top=n&till_date=<YYYY-MM-DD>
...
** Search usage analytics on openedx platform
   ...
   - Query to get the lab-wise usage of openedx platform
    ...
    #+END_EXAMPLE
*** Search lab usage analytics hosted on openedx platform using lab's attributes
**** API Design
  :PROPERTIES:
  ...
  :END:          
    ...
    - URL :: /labs/openedx/_search?lab_id=cse02
...
def get_openedx_search_usage(entity, platform):
    ...
    if request.method == 'GET':
        ...
        if platform == "openedx" or platform == "nonopenedx":
            ...
            if res.status_code == 200:
                non_open_edx_lab = True
                non_open_edx_usage = res.json()
            else:
                non_open_edx_lab = False
                status_code = res.status_code
                current_app.logger.error("Error code = %s" % (status_code))

            try:
                vlabs_dict = {}
                if (open_edx_lab and non_open_edx_lab):
                    non_openedx_usage = non_open_edx_usage['usage']
                    openedx_usage = open_edx_usage['usage']
                    open_edx_usage['usage'] = {}
                    open_edx_usage['usage']["nonopenedx_usage"] = \
                      non_openedx_usage
                    open_edx_usage['usage']["openedx_usage"] = openedx_usage
                    vlabs_dict = open_edx_usage

                elif (not open_edx_lab and non_open_edx_lab):
                    non_openedx_usage = non_open_edx_usage['usage']
                    non_open_edx_usage['usage'] = {}
                    non_open_edx_usage['usage']["nonopenedx_usage"] = \
                      non_openedx_usage
                    non_open_edx_usage['usage']["openedx_usage"] = 0
                    vlabs_dict = non_open_edx_usage

                elif (open_edx_lab and not non_open_edx_lab):
                    openedx_usage = open_edx_usage['usage']
                    open_edx_usage['usage'] = {}
                    open_edx_usage['usage']["nonopenedx_usage"] = 0
                    open_edx_usage['usage']["openedx_usage"] = openedx_usage
                    vlabs_dict = open_edx_usage
...
*** Get usage analytics of labs hosted on non openedx platform
**** API Design
  :PROPERTIES:
  :CUSTOM_ID: openedx_usage
  :END:          

    - URL :: /labs/nonopenedx?top=n&till_date=<YYYY-MM-DD>
    ...
    - Example call ::
      #+BEGIN_EXAMPLE
      curl -XGET http://localhost:5000/labs/nonopenedx?top=2&till_date=2017-09-20
      #+END_EXAMPLE
    - Notes ::
...
**** API Design
  ...
  :END:          
    ...
    - URL :: /institutes/nonopenedx?top=n&till_date=<YYYY-MM-DD>
    ...
    - Example call ::
      #+BEGIN_EXAMPLE
      curl -XGET http://localhost:5000/institutes/nonopenedx?top=2&till_date=2017-09-20
      #+END_EXAMPLE
    - Notes ::
...
**** API Design
  ...
  :END:          
    ...
    - URL :: /disciplines/nonopenedx?top=n&till_date=<YYYY-MM-DD>
    ...
    - Example call ::
      #+BEGIN_EXAMPLE
      curl -XGET http://localhost:5000/disciplines/nonopenedx?top=2&till_date=2017-09-20
      #+END_EXAMPLE
    - Notes ::
