...
* Install Elasticsearch database in your development machine 
  ...
  must install elasticsearch database.  Refer [[https://github.com/openedx-vlead/elk-stack-for-analytics/blob/master/src/index.org#install-elk][to install Elasticsearch]]
