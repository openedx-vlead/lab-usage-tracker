...
* Milestones Snapshot
  ...
  |   | no | no | Map |                                  |      |        | hrs | hrs |        |
  |---+----+----+-----+----------------------------------+------+--------+-----+-----+--------|
  |   | 1  | [[https://github.com/vlead/analytics-db/milestone/1][1]]  |     | [[https://github.com/vlead/vlabs-analytics-service/milestone/1][Implement REST API(s) interfaces]] |      | Closed | 203 | 218 | [[https://github.com/vlead/analytics-db/milestones/ADS%2520deployment%2520and%2520implementation%2520of%2520backup%2520restore%2520script][ref]]    |
  |---+----+----+-----+----------------------------------+------+--------+-----+-----+--------|
  |   |    |    |     | Total                            |      |        | 203 | 218 |        |
  | ^ |    |    |     |                                  |      |        | et  | at  |        |
  |---+----+----+-----+----------------------------------+------+--------+-----+-----+--------|
