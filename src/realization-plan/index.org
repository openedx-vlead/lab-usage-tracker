...
** [[https://github.com/vlead/vlabs-analytics-service/milestone/1][Milestone]]
  ...
  1) APIs to store/retrieve the usage analytics of labs hosted on Openedx and
     college cloud edition
  2) APIs to store/retrieve the user analytics of Openedx platform
  3) APTs to store/retrieve feedback analytics of vlabs and college cloud platform
