...
* Milestones Snapshot
  ...
  |---+----+----+-----+----------------------------------+------+--------+-----+-----+--------|
  |   |  2 | [[https://github.com/vlead/analytics-db/milestone/1][1]]  |     | [[https://github.com/vlead/vlabs-analytics-service/milestone/1][Implement REST API(s) interfaces]] |      | Closed |  88 |  30 | [[https://github.com/vlead/vlabs-analytics-service/milestones/Implement%2520REST%2520API%2528s%2529%2520interfaces][ref]]    |
  |---+----+----+-----+----------------------------------+------+--------+-----+-----+--------|
  |   |    |    |     | Total                            |      |        | 291 | 248 |        |
  | ^ |    |    |     |                                  |      |        |  et |  at |        |
  |---+----+----+-----+----------------------------------+------+--------+-----+-----+--------|
